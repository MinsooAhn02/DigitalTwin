...
\begin{itemize}
  ...
  three-lock concurrency model (\texttt{\_state\_lock},
...
\begin{itemize}
  ...
  and slow EMA adaptation ($\alpha{=}0.99$) to handle ITS measurement
  uncertainty. The factor persists across sessions and converges to an
